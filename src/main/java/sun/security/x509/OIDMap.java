...
public class OIDMap {
    ...
    private static final String AUTH_KEY_IDENTIFIER = ROOT + "." + "AuthorityKeyIdentifier";
    ...
    private static final String BASIC_CONSTRAINTS   = ROOT + "." + "BasicConstraints";
    ...
    private static final String CRL_REASON  = ROOT + "." + "CRLReasonCode";
                                              //CRLReasonCodeExtension.NAME;
    private static final String NETSCAPE_CERT  = ROOT + "." +
                                              NetscapeCertTypeExtension.NAME;
    private static final String CERT_POLICIES = ROOT + "." + "CertificatePolicies";
    ...
    private static final String CERT_ISSUER = ROOT + "." + "CertificateIssuer";
                                        //CertificateIssuerExtension.NAME;
    private static final String SUBJECT_INFO_ACCESS = ROOT + "." +
                                          SubjectInfoAccessExtension.NAME;
    private static final String AUTH_INFO_ACCESS = ROOT + "." + "AuthorityInfoAccess";
